...
namespace ConferencePlanner.FrontEnd.TagHelpers
{
    ...
    public class AuthzTagHelper : TagHelper
    {
        ...
        public AuthzTagHelper(IAuthorizationService authorizationService)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            if (context.AllAttributes.Any(a => a.Name.Equals("authz"))
                && !requiresAuth && ViewContext.HttpContext.User.Identity.IsAuthenticated)
            {
            ...
            else if (!string.IsNullOrEmpty(RequiredPolicy))
            {
                ...
                {
                    var authResult = await authorizationService.AuthorizeAsync(ViewContext.HttpContext.User, RequiredPolicy);
